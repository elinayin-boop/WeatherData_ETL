...
with DAG(
    dag_id = 'weather_ETL__incremental', # TO DO: add incremental as a suffix to the DAG id
    ...
    CITY = "LosAngeles"               # TO DO: Set the city name to your coordinates' city name
    
    database = "user_db_gopher"           # TO DO: Set the database name  
    schema = "raw"
